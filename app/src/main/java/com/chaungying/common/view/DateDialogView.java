 ...
 */
public class DateDialogView extends FrameLayout {
    ...
    public DateDialogView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DateDialogView(Context context, AttributeSet attrs, int defStyleAttr) {
