package com.chaungying.common.pickerview.view;

import android.content.Context;
import android.view.View;

import com.chaungying.common.listener.OnItemSelectedListener;
import com.chaungying.common.pickerview.adapter.NumericWheelAdapter;
import com.chaungying.common.pickerview.adapter.WheelAdapter;
import com.chaungying.common.pickerview.lib.WheelView;
import com.chaungying.common.pickerview.view.TimePickerView.Type;
...
public class WheelTime {
    ...
    ////////////////////////对分钟的操作///////////////////////////
    public static final int DEFULT_MINUTS_INTERVAL = 1;
    private int minuts_interval = DEFULT_MINUTS_INTERVAL;

    // TODO: 王晓赛 2016年8月01日 设置分钟的间隔
    public void setMinutsInterval(int interval) {
        minuts_interval = interval;
    }

    private WheelAdapter minutsAdapter = new WheelAdapter() {
        String format = "%02d";
        int minValue = 0;
        ...
        public Object getItem(int index) {
            if (minuts_interval != 1) {
                int value = minValue + index % 6 * 10;
...
//		wv_mins.setAdapter(new NumericWheelAdapter(0, 59, "%02d"));
        wv_mins.setAdapter(minutsAdapter);
