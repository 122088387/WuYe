 ...
 * 用车管理的预定Activity
 */
@ContentView(R.layout.activity_use_car_order)
public class UseCarOrderActivity extends BaseActivity {
...
//    private EditText et_bei_zhu;
    ...
    private void initData() {
        setActionBar(R.string.use_car_order, R.drawable.nav_return, 0);
        AllCarBean bean = (AllCarBean) getIntent().getExtras().getSerializable("bean");
        order_name.setText(bean.getName());
        order_data.setText(UseCarSelectActivity.data);
    ...
    private void order(View view) {
        ...
        RequestParams params = new RequestParams(Const.WuYe.URL_USER_CAR_ORDER);
        params.addParameter("appointmentDate", UseCarSelectActivity.data);
        params.addParameter("groupName", order_group.getText().toString());//预定的单位
        params.addParameter("carId", id);//会议室的id
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (base.respCode == 1001) {
                    T.showShort(UseCarOrderActivity.this, "预定成功");
//                    Intent intent = new Intent();
//                    intent.setClass(UseCarOrderActivity.this, UseCarActivity.class);
//                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                    startActivity(intent);
                    finish();
                } else {
                    T.showShort(UseCarOrderActivity.this, base.respMsg);
                }
            }

            @Override
            public void onError(Throwable ex, boolean isOnCallback) {
                T.showShort(UseCarOrderActivity.this, "提交失败");
            }
