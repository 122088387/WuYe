 ...
 */
public class MettingRoomSelectAdapter extends BaseAdapter {

    private Context mContext;
    List<MettingRoomSelectBean.DatasBean> list = new ArrayList<>();

    public MettingRoomSelectAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public void setList(List<MettingRoomSelectBean.DatasBean> list) {
        this.list = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView == null){
            convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_metting_room_select_item,null);
        ...
        MettingRoomSelectBean.DatasBean bean = list.get(position);
    ...
    class MyListner implements View.OnClickListener{
        ...
        private MettingRoomSelectBean.DatasBean bean;

        public MyListner(MettingRoomSelectBean.DatasBean bean) {
            this.bean = bean;
        }
