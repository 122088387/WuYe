package com.chaungying.modues.main.spinner_view;
...
import com.chaungying.modues.main.view.MaxHeightListView;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        listView = new MaxHeightListView(context);
        // Set the spinner's id into the listview to make it pretend to be the right parent in
        // onItemClick
        listView.setId(getId());
        listView.setDivider(context.getResources().getDrawable(R.drawable.list_item_divider_1));
    ...
    public <T> void attachDataSource(@NonNull List<T> dataset) {
        adapter = new NiceSpinnerAdapter<>(getContext(), dataset, textColor, R.color.E9F1FF);
