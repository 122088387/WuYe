package com.chaungying.calendar.views;
...
import com.chaungying.calendar.bizs.calendars.DPCManager;
import com.chaungying.calendar.bizs.decors.DPDecor;
import com.chaungying.calendar.bizs.themes.DPTManager;
import com.chaungying.calendar.cons.DPMode;
import com.chaungying.calendar.entities.DPInfo;
                    ...
                    if (mDPMode == DPMode.SINGLE) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                            ValueAnimator animScale1 = ObjectAnimator.ofInt(
                                    circle, "radius", 0, circleRadius - temp);
