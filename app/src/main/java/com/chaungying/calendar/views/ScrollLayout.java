...
public class ScrollLayout extends FrameLayout implements MonthView.OnLineCountChangeListener,
    ...
    private FillListView contentLayout;
    ...
    private CalendarTextView weekTxt;
    ...
    protected void onFinishInflate() {
        ...
        mainLayout = (LinearLayout) findViewById(R.id.calendar_layout);
        monthView = (MonthView) findViewById(R.id.month_calendar);
        weekTxt = (CalendarTextView) findViewById(R.id.week_text);
        ...
        contentLayout = (FillListView) findViewById(R.id.content_layout);
