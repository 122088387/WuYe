...
public class OrderListDetailsAdapter extends BaseAdapter {
    ...
    List<OrderListDetailsBean.DatasBean> payMoneyGoodsBeanList = new ArrayList<>();

    private Context mContext;

    public OrderListDetailsAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public void setPayMoneyGoodsBeanList(List<OrderListDetailsBean.DatasBean> payMoneyGoodsBeanList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.pay_money_item_name.setText(payMoneyGoodsBeanList.get(i).getProName());
        holder.pay_money_item_price.setText("￥" + payMoneyGoodsBeanList.get(i).getActualPrice());
        holder.pay_money_item_num.setText("×" + payMoneyGoodsBeanList.get(i).getBuyCount());
