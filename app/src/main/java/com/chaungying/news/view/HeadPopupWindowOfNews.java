 ...
 */
public class HeadPopupWindowOfNews extends PopupWindow implements View.OnClickListener {
    ...
    public HeadPopupWindowOfNews(Activity context) {
        super(context);
        mContext = context;
...
//                        dismiss();
    ...
    private HeadPopupListener listener;

    public void setListener(HeadPopupListener listener) {
        this.listener = listener;
    }

    /**
     * 将发布新闻中的弹出 选择图片或者相册的监听回调给CameraViewOfNews
     */
    public interface HeadPopupListener {
        void listener(int tag);
    }
}